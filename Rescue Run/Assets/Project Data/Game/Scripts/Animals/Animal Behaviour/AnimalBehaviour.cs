...
namespace Watermelon
{
    ...
    public class AnimalBehaviour : MonoBehaviour
    {
        ...
        public void PickAnimal(IAnimalCarrying carrying, bool isAllowToCarry = true)
        {
            if (isPicked)
                return;
        ...
        public void CreateWaitingIndicator(IAnimalCarrying carrying,bool isAllowToCarry = true)
        {
            if (isCured)
                return;
            ...
            activeWaitingIndicator.Initialise(LevelController.AnimalPickUpDuration, delegate
            {
                ...
                {
                    PickAnimal(carrying, isAllowToCarry);
                    AudioController.PlaySound(AudioController.Sounds.animalPickUpSound);
                }
            });
        }
        ...
        public void FollowTarget(Transform target,float speed)
        {
            ...
            gameObject.transform.position = Vector3.Lerp(gameObject.transform.position, targetPosition, followSpeed * Time.deltaTime);
